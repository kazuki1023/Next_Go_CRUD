...
func (ec *EventCreate) SetGeneration(s string) *EventCreate {
	ec.mutation.SetGeneration(s)
	return ec
}
...
func (ec *EventCreate) SetFinishDate(t time.Time) *EventCreate {
	ec.mutation.SetFinishDate(t)
	return ec
}
...
func (ec *EventCreate) check() error {
	...
	if _, ok := ec.mutation.Generation(); !ok {
		return &ValidationError{Name: "generation", err: errors.New(`ent: missing required field "Event.generation"`)}
	}
	...
	if _, ok := ec.mutation.FinishDate(); !ok {
		return &ValidationError{Name: "finish_date", err: errors.New(`ent: missing required field "Event.finish_date"`)}
	}
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.Generation(); ok {
	...
	if value, ok := ec.mutation.FinishDate(); ok {
